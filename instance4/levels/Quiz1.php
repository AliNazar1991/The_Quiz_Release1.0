...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
   				...
   				<br>
				<input type=radio name="q1" value="a" onclick="changequiz(),wronganswer('wrong')"> d * 3,14<br>
				<input type=radio name="q1" value="b" onclick="changequiz(),increasexp(150)"> r* r* 3,14 <br>
				<input type=radio name="q1" value="c" onclick="changequiz(),wronganswer('wrong')"> r * pi<br>
