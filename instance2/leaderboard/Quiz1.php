...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
   				...
   				<br>
				<input type=radio name="q1" value="a" onclick="changequiz(),wronganswer('wrong')"> Sangachok<br>
				<input type=radio name="q1" value="b" onclick="changequiz(),increasexp(100)"> Kathmandu <br>
				<input type=radio name="q1" value="c" onclick="changequiz(),wronganswer('wrong')"> Hetauda<br>
