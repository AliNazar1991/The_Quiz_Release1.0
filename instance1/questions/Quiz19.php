...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
		...
		if (window.XMLHttpRequest)
				...
				var x=xmlDoc.getElementsByTagName("QUIZ19");
   			...
   			<div id="question"><b></b></div><br>
				...
				<input type=radio name="q1" value="c" onclick="changequiz(),wronganswer('wrong')"><div id="WrongAnswer2" style="display:inline">   
