...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
   				...
   				<br>
				<input type=radio name="q1" value="a" onclick="changequiz(),wronganswer('wrong')"> John W. Thompson<br>
				<input type=radio name="q1" value="b" onclick="changequiz(),increasexp(100)"> Bill Gates & Paul Allen <br>
				<input type=radio name="q1" value="c" onclick="changequiz(),wronganswer('wrong')"> Bill Gates & Steve Ballmer<br>
